        ...
        <form action="{{ route('projects.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required
                       ...
                       class="w-full px-3 py-2 rounded-md border border-gray-300 text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition-all duration-150">
            </div>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4"
                          ...
                          class="w-full px-3 py-2 rounded-md border border-gray-300 text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition-all duration-150 resize-none">{{ old('description') }}</textarea>
            </div>
